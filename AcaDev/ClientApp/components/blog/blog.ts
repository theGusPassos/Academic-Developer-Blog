...
export default class BlogComponent extends Vue {
    ...
    fetchPosts() {
        // mocked posts
        this.posts = [
            { id: 1, title: 'Trying to Creating new Stuff', date: new Date(), author: 'Gustavo Passos', tags: ['.net core'], content: 'Ullamco enim cillum nostrud officia tempor. Nostrud do id laboris eu id fugiat aliquip laboris aute veniam sint aute. Sunt ad sint consectetur cillum duis adipisicing sit id duis.' },
